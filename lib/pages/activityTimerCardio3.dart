...
class ActivityCardio3 extends StatefulWidget {
  const ActivityCardio3({Key key}) : super(key: key);

  @override
  _ActivityCardio3State createState() => _ActivityCardio3State();
}

class _ActivityCardio3State extends State<ActivityCardio3> {
  int seconds = 120;

...
class ActivityUpper1 extends StatefulWidget {
  const ActivityUpper1({Key key}) : super(key: key);

  @override
  _ActivityUpper1State createState() => _ActivityUpper1State();
}

class _ActivityUpper1State extends State<ActivityUpper1> {
  int seconds = 120;

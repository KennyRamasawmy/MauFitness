...
class ActivityCardio2 extends StatefulWidget {
  const ActivityCardio2({Key key}) : super(key: key);

  @override
  _ActivityCardio2State createState() => _ActivityCardio2State();
}

class _ActivityCardio2State extends State<ActivityCardio2> {
  int seconds = 120;

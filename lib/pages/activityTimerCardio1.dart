...
class ActivityCardio1 extends StatefulWidget {
  const ActivityCardio1({Key key}) : super(key: key);

  @override
  _ActivityCardio1State createState() => _ActivityCardio1State();
}

class _ActivityCardio1State extends State<ActivityCardio1> {
  int seconds = 120;

import 'package:MauFitness/timer/ScreenlowB.dart';
import 'package:flutter/material.dart';
import 'package:MauFitness/models/challengesB.dart';
import 'package:MauFitness/pages/challenges_rowB.dart';
...
class ChallengedetailB extends StatelessWidget {
  final ChallengeB challengeb;
  ChallengedetailB(this.challengeb);
 ...
 ShakeDetector detector;
          ...
          new Container(
            ...
            child: new Column(
              ...
              children: <Widget>[
                ...
                new Separator(),
                new Text(challengeb.description, style: Style.commonTextStyle1),
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          //builder: (context) => TimerScreenB(challengeb)));
                          builder: (context) => TimelowB(challengeb)));
                    },
                    child: const Padding(
  ...
  Container _getTextToSPeech(BuildContext context) {
        _speak() async {
          ...
          await flutterTts.speak(challengeb.description);
        }

...
class ActivityUpper2 extends StatefulWidget {
  const ActivityUpper2({Key key}) : super(key: key);

  @override
  _ActivityUpper2State createState() => _ActivityUpper2State();
}

class _ActivityUpper2State extends State<ActivityUpper2> {
  int seconds = 120;

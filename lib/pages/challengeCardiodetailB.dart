import 'package:MauFitness/timer/ScreencardioB.dart';
...
class ChallengedetailBCardio extends StatelessWidget {
  final ChallengeBCardio challengebCardio;
  ChallengedetailBCardio(this.challengebCardio);
  ...
  Container _getContent(BuildContext context) {
          ...
          new Container(
            ...
            child: new Column(
              ...
              children: <Widget>[
                ...
                new Separator(),
                new Text(challengebCardio.description,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => TimeCB(challengebCardio)));
                    },
                    child: const Padding(
    ...
    Container _getTextToSPeech(BuildContext context) {
        _speak() async {
          ...
          await flutterTts.speak(challengebCardio.description);
        }

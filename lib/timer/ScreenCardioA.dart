...
import 'package:MauFitness/screens/TrophyUnlockCA.dart';
import 'package:flutter/material.dart';

class TimeCA extends StatefulWidget {
  final ChallengeACardio challengeaCardio;
  TimeCA(this.challengeaCardio);

  @override
  _TimeCAState createState() => _TimeCAState(this.challengeaCardio);
}

class _TimeCAState extends State<TimeCA> {
  ...
  final ChallengeACardio challengeaCardio;
  _TimeCAState(this.challengeaCardio);
  ...
  Widget build(BuildContext context) {
    ...
    if ((this.minutes) == 5) {
      ...
      Future.delayed(Duration.zero, () {
        if (challengeaCardio.id == 5) {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => TrophyUnlockCA()));
        } else {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => ChallengedetailACardio(
                  challengesACardio[(challengeaCardio.id)])));
        }
      });
    }
    return Scaffold(

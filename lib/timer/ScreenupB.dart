...
import 'package:MauFitness/models/challengesB.dart';
import 'package:MauFitness/models/challengesBUpperBody.dart';
import 'package:MauFitness/pages/challengeUpperDetailB.dart';
import 'package:MauFitness/pages/challengelowdetailB.dart';
import 'package:MauFitness/screens/TrophyUnlockLB.dart';
import 'package:MauFitness/screens/TrophyUnlockUB.dart';
import 'package:flutter/material.dart';

class TimeupB extends StatefulWidget {
  final ChallengeBUpperBody challengebUpperBody;
  TimeupB(this.challengebUpperBody);

  @override
  _TimeupBState createState() => _TimeupBState(this.challengebUpperBody);
}

class _TimeupBState extends State<TimeupB> {
  ...
  final ChallengeBUpperBody challengebUpperBody;
  _TimeupBState(this.challengebUpperBody);
  ...
  Widget build(BuildContext context) {
    ...
    if ((this.minutes) == 5) {
      ...
      Future.delayed(Duration.zero, () {
        if (challengebUpperBody.id == 5) {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => TrophyUnlockUB()));
        } else {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => ChallengedetailBUpper(
                  challengesBUpperBody[(challengebUpperBody.id)])));
        }
      });
    }
    return Scaffold(

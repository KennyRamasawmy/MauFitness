...
import 'package:MauFitness/screens/TrophyUnlockLA.dart';
import 'package:flutter/material.dart';

class TimelowA extends StatefulWidget {
  final ChallengeA challengea;
  TimelowA(this.challengea);

  @override
  _TimelowAState createState() => _TimelowAState(this.challengea);
}

class _TimelowAState extends State<TimelowA> {
  ...
  final ChallengeA challengea;
  _TimelowAState(this.challengea);
      ...
      Future.delayed(Duration.zero, () {
        if (challengea.id == 5) {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => TrophyUnlockLA()));
        } else {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) =>
                  ChallengedetailA(challengesA[(challengea.id)])));
        }
      });
    }
    return Scaffold(

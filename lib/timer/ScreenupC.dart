...
import 'package:MauFitness/screens/TrophyUnlockLC.dart';
import 'package:MauFitness/screens/TrophyUnlockUC.dart';
import 'package:flutter/material.dart';

class TimeupC extends StatefulWidget {
  final ChallengeCUpperBody challengecUpperBody;
  TimeupC(this.challengecUpperBody);

  @override
  _TimeupCState createState() => _TimeupCState(this.challengecUpperBody);
}

class _TimeupCState extends State<TimeupC> {
  ...
  final ChallengeCUpperBody challengecUpperBody;
  _TimeupCState(this.challengecUpperBody);
  ...
  Widget build(BuildContext context) {
    ...
    if ((this.minutes) == 5) {
      ...
      Future.delayed(Duration.zero, () {
        if (challengecUpperBody.id == 5) {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => TrophyUnlockUC()));
        } else {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => ChallengedetailCUpper(
                  challengesCUpperBody[(challengecUpperBody.id)])));
        }
      });
    }
    return Scaffold(

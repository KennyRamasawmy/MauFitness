...
import 'package:MauFitness/screens/TrophyUnlockUA.dart';
import 'package:flutter/material.dart';

class TimeupA extends StatefulWidget {
  final ChallengeAUpperBody challengeaUpperBody;
  TimeupA(this.challengeaUpperBody);

  @override
  _TimeupAState createState() => _TimeupAState(this.challengeaUpperBody);
}

class _TimeupAState extends State<TimeupA> {
  ...
  final ChallengeAUpperBody challengeaUpperBody;
  _TimeupAState(this.challengeaUpperBody);
  ...
  Widget build(BuildContext context) {
    ...
    if ((this.minutes) == 5) {
      ...
      Future.delayed(Duration.zero, () {
        if (challengeaUpperBody.id == 5) {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => TrophyUnlockUA()));
        } else {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => ChallengedetailAUpper(
                  challengesAUpperBody[(challengeaUpperBody.id)])));
        }
      });
    }
    return Scaffold(

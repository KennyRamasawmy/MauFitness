...
class TimelowC extends StatefulWidget {
  final ChallengeC challengec;
  TimelowC(this.challengec);

  @override
  _TimelowCState createState() => _TimelowCState(this.challengec);
}

class _TimelowCState extends State<TimelowC> {
  ...
  final ChallengeC challengec;
  _TimelowCState(this.challengec);
      ...
      Future.delayed(Duration.zero, () {
        if (challengec.id == 5) {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => TrophyUnlockLC()));
        } else {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) =>
                  ChallengedetailC(challengesC[(challengec.id)])));
        }
      });
    }
    return Scaffold(
